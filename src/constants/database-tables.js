...
export const HEALTH_TRACKING_CATEGORY = 'health_tracking_category';
export const HEALTH_TRACKING_OPTION = 'health_tracking_option';
export const PREGNANCY = 'pregnancy';
export const REMINDER = 'reminder';
export const USER_REMINDER = 'user_reminder';

...
const Start1 = (props) => {
    ...
    const Login = () => {
        if (selected.selected1 == false && selected.selected2 == false && selected.selected3 == false)
            ToastAndroid.show("لطفا یکی از گزینه ها را انتخاب نمایید", ToastAndroid.SHORT);
            ...
            <View style={styles.view}>
                ...
                <TouchableOpacity onPress={() => setSelected({ selected1: true })}>
                    <View style={styles.view2}>
                        <Radio selected={selected.selected1}
                            color='#F700FF'
                ...
                <TouchableOpacity onPress={() => setSelected({ selected2: true })}>
                    ...
                    <Text style={styles.txt2}>بعضی روزها برایم مهم و تایین کننده هستند</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setSelected({ selected3: true })}>
                    <View style={styles.view2}>
                        <Radio selected={selected.selected3}
                            color='#F700FF'
                            selectedColor='#F93DFF'

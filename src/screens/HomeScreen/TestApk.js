...
import { ImageBackground, StyleSheet, Text, StatusBar, Image } from 'react-native';
...
const Home = (props) => {
    ...
    if (year == 2020 && month < 6)
        ...
        <View style={{ backgroundColor: 'pink', flex: 1, justifyContent: 'center' }}>
            ...
            <Text style={{ alignSelf: 'center', fontFamily: fonts.regular, fontSize: size[24] }} > پرتو دستیار هوشمند سلامت بانوان  </Text>
        </View>
    )

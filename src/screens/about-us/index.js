    ...
    <ImageBackground
      ...
      <ScrollView style={{ marginBottom: 50 }}>
        ...
        <Ptxt style={styles.txt}>
          ...
          پرتو را ساخته و بر محتوای علمی آن نظارت مستقیم دارند. محتوای علمی پرتو
          چه منابعی دارد؟ منابع پرتو، به روز ترین مقالات و کتب مرجع علمی انگلیسی
          و فارسی زبان است که توسط کارشناسان سلامت تحقیق، جمع آوری و بازنویسی
          شده است. تولید محتوای علمی متناسب با نیاز کاربر برای تیم پرتو یک
          فرایند بومی سازی شده با گذراندن مراحلی شامل تحقیق، تدوین، بازنویسی و
          ویرایش است. این تلاش برای قابل فهم تر شدن مطالب علمی و پزشکی برای
          مخاطبان عزیز پرتوست. تولید پرتو برای همه ی اعضا با هدف ارزشمند آگاهی
          بخشی و ارائه محتوای علمی دقیق و سالم به زنان ایران زمین انجام شده است.
          سلامتی روح و جسم همه ی زنان جهان آرزوی قلبی ماست.
        </Ptxt>
        <Text style={styles.question}>
          {'  '}
